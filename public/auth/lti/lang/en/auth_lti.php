...
$string['default_settings'] = 'LTI Advantage Default settings';
$string['roleinstructor'] = 'Role for teacher';
$string['roleinstructor_help'] = 'The default role assigned in the tool to the remote teacher.';
$string['rolelearner'] = 'Role for student';
$string['rolelearner_help'] = 'The default role assigned in the tool to the remote student.';
$string['modeinstructordefault'] = 'Teacher first launch provisioning mode';
$string['modeinstructordefault_help'] = 'The default account provisioning mode for new users with instructor role on first LTI launch, including if the user\'s initial launch is for deep link selection.';
$string['modelearnerdefault'] = 'Student first launch provisioning mode';
$string['modelearnerdefault_help'] = 'The default provisioning mode for new users with learner role on first LTI launch';